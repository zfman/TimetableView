...
import com.zhuangfei.timetable.model.ToggleEnable;
 ...
 *
 */
public class TimetableView extends LinearLayout implements ToggleEnable{

	private static final String TAG = "TimetableView";

	private Context context;
	private ScheduleConfig config;
	private ScheduleManager manager2;
	...
	public TimetableView(Context context, AttributeSet attrs) {
        ...
        config=new ScheduleConfig(context);
		manager2=new ScheduleManager(config,inflater);
