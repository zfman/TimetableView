...
import com.zhuangfei.timetable.core.R;
...
public class SubjectUIModel {
	...
	public SubjectUIModel(Context context, OnSubjectItemClickListener onSubjectItemClickListener) {
				...
				textView.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						...
						if (onSubjectItemClickListener != null)
							onSubjectItemClickListener.onItemClick(v, result);
					}
				});
